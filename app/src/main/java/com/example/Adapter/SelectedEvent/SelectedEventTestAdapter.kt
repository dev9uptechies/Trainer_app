...
class SelectedEventTestAdapter(
    private var user: List<SelectedEventModel.Test>,
    var context: Context,
    val listener: OnItemClickListener.OnItemClickCallback
) : RecyclerView.Adapter<SelectedEventTestAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.tvAthlete.text = data?.test_athletes
